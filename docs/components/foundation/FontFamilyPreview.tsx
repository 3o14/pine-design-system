...
import { fontFamily } from "pine-design-system";

const ROWS = [
  { theme: "basic", name: "sans (Inter)", key: "sans" },
  { theme: "basic", name: "mono (Roboto Mono)", key: "mono" },
  { theme: "game", name: "pixel (DungGeunMo)", key: "pixel" },
  { theme: "crayon", name: "crayon (온글잎-승훈체)", key: "crayon" },
] satisfies ReadonlyArray<{
  theme: string;
  name: string;
  key: keyof typeof fontFamily;
}>;
  ...
  return (
    <div className="my-6">
      <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-4">
        {ROWS.map(({ theme, name, key }) => {
          const stack = fontFamily[key];
          return (
            <div
              key={name}
